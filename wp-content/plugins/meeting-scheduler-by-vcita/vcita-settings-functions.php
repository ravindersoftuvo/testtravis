    ...
    ?>
		...
		<div class="vcita-wrap" dir="ltr">
			<div id="vcita-head">
	    		...
	    		<br>
	    		<a href="https://www.vcita.com/education_center?item=3-1" class="watch-video show-in-popup" id="play-vcita-video2">Watch Video</a>
	    	</div>
	    	...
	    	<div class="vcita-footer">
	    		...
	    		<div class="more-offers left">
	    			...
	    			Visit <a target="_blank" href="http://<?php echo VCITA_SERVER_BASE ?>?invite=<?php echo VCITA_WIDGET_INVITE_CODE ?>">vCita</a> or <a href="https://www.vcita.com/education_center" id="not-play-vcita-video" class="show-in-popup">watch a video</a>
	    			<br>
	    			Any suggestions or questions? visit our <a target="_blank" href="https://support.vcita.com/forums">forum</a>
	    		</div>
	    		<div class="clear"></div>
	    	</div>
	    </div>
